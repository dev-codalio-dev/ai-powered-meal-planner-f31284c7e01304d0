const api = {
  ...
  "components": {
    "schemas": {
      ...
      "meal_plan_item": {
        "x-rhino-model": {
          "model": "meal_plan_item",
          "modelPlural": "meal_plan_items",
          "name": "mealPlanItem",
          "pluralName": "mealPlanItems",
          "readableName": "Meal plan item",
          "pluralReadableName": "Meal plan items",
          "ownedBy": "meal_plan",
          "singular": false,
          "path": "/api/meal_plan_items",
          "searchable": false
        },
        "type": "object",
        "properties": {
      ...
      "shopping_list_item": {
        "x-rhino-model": {
          ...
          "modelPlural": "shopping_list_items",
          "name": "shoppingListItem",
          "pluralName": "shoppingListItems",
          "readableName": "Shopping list item",
          "pluralReadableName": "Shopping list items",
          "ownedBy": "user",
          "singular": false,
          "path": "/api/shopping_list_items",
          "searchable": false
        },
        "type": "object",
        "properties": {
  ...
  "paths": {
    ...
    "/api/ingredients/:id": {
      ...
      "delete": {
        "operationId": "ingredient-destroy",
        "parameters": [
          {
            "name": "id",
            "in": "path",
    ...
    "/api/meal_plan_items": {
      "get": {
        "operationId": "meal_plan_item-index",
        "parameters": [
        ...
        "responses": {
          "200": {
            ...
            "content": {
              "application/json": {
                "schema": {
                  "$ref": "#/components/schemas/meal_plan_item"
                }
              }
            }
          },
      ...
      "post": {
        "operationId": "meal_plan_item-create",
        "parameters": [
    ...
    "/api/meal_plan_items/:id": {
      "get": {
        "operationId": "meal_plan_item-show",
        "parameters": [
          {
            "name": "id",
            "in": "path",
      ...
      "patch": {
        "operationId": "meal_plan_item-update",
        "parameters": [
          {
            "name": "id",
            "in": "path",
      ...
      "delete": {
        "operationId": "meal_plan_item-destroy",
        "parameters": [
          {
            "name": "id",
            "in": "path",
    ...
    "/api/shopping_list_items": {
      "get": {
        "operationId": "shopping_list_item-index",
        "parameters": [
      ...
      "post": {
        "operationId": "shopping_list_item-create",
        "parameters": [
    ...
    "/api/shopping_list_items/:id": {
      "get": {
        "operationId": "shopping_list_item-show",
        "parameters": [
          {
            "name": "id",
            "in": "path",
      ...
      "patch": {
        "operationId": "shopping_list_item-update",
        "parameters": [
          {
            "name": "id",
            "in": "path",
      ...
      "delete": {
        "operationId": "shopping_list_item-destroy",
        "parameters": [
          {
            "name": "id",
            "in": "path",
